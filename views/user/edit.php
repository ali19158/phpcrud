                        ...
                        <input type='hidden' name='id' value="<?php echo $id;?>">
                           ...
                           <!-- <input type='hidden' name='_method' value="PUT">
                            ...
                            <div class="form-group">
                                ...
                                <input name="age" type="text" class="form-control" id="age" value="<?php echo $user->age;?>">
                            </div>
                            <div class="form-group">
                                <label for="occupation">Occupation:</label>
                                <input name="occupation" type="text" class="form-control" id="occupation" value="<?php echo $user->occupation;?>">
                            </div>
